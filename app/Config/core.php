 ...
 */
if ( isset($_SERVER['SERVER_NAME']) && ($_SERVER['SERVER_NAME'] == 'sci.ncas.ac.uk' OR $_SERVER['SERVER_NAME'] == '192.168.56.102' ))
{
   #is live
 ...
 */
	Configure::write('Security.salt', 'zfsdmvbsdmjhgvsdhbRDFJHb|MYSFJBx<K|YHJ^^');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '9853431836435761356543518');
